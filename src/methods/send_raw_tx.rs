...
impl RpcMethod for RpcSendRawTransactionRequest {
    ...
    fn params(&self) -> Result<serde_json::Value, io::Error> {
        Ok(json!({
                "signed_tx_base64": common::encode_signed_transaction(self.raw_signed_transaction.clone())?,
                "wait_until": self.wait_until
        }))
    }
}

impl private::Sealed for RpcSendRawTransactionRequest {}
